...
\begin{tikzpicture}
  \node [anchor=east] at (0,0.25) {Unreal Engine 4};
  \draw [fill=gray] (2,0) rectangle (7,.5);
  \draw [fill={rgb:red,1;green,2;blue,3}] (3,0) rectangle (7,.5);
  \end{tikzpicture}\\

\begin{tikzpicture}
  \node [anchor=east] at (8,0.25) {Unity 3D};
...
\begin{tikzpicture}
  \node [anchor=east] at (0,0.25) {\LaTeX};
  \draw [fill=gray] (2,0) rectangle (7,.5);
  \draw [fill={rgb:red,1;green,2;blue,3}] (3,0) rectangle (7,.5);
  \end{tikzpicture}\\

\begin{tikzpicture}
  \node [anchor=east] at (8,0.25) {PHP};
  \draw [fill=gray] (0,0) rectangle (5,.5);
  \draw [fill={rgb:red,1;green,2;blue,3}] (0,0) rectangle (3.5,.5);
  \end{tikzpicture}\\
