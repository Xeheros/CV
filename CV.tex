...
\begin{twenty} % Environment for a list with descriptions
	...
	\twentyitem{2010--2012}{DUT Informatique}{Reims}{OpenGL Option}
...
\begin{twenty}
	\twentyitem{2019}{Pentagrave}{Concept}{Multiplayer Hack'n'Slash currently in design state.}
	\twentyitem{2016}{Warlock: First Fright}{PC Prototype}{Arena game, based on a Warcraft 3 mod, where players have to push their opponents out of the platform.}
\end{twenty}
...
\begin{twenty}
	\twentyitem{French}{Native}{}{}
	\twentyitem{English}{Read, Written, Spoken}{}{}
\end{twenty}
%----------------------------------------------------------------------------------------
%	 HOBBIES
%----------------------------------------------------------------------------------------
